<#
.SYNOPSIS
    Generates human-readable security reports from PSTS analysis results.
.DESCRIPTION
...
3. **Run Re-Analysis:** After fixes, re-run PSTS to verify all issues are resolved
...
*Generated by PSTS v$($results.metadata.version)*
"@
