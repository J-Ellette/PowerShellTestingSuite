...
<#
.SYNOPSIS
    Test suite for PSTS CLI (psts.ps1)
.DESCRIPTION
    Comprehensive tests for the PowerShield Testing Suite CLI wrapper
.NOTES
...
Write-Host "PSTS CLI Tests (psts.ps1)" -ForegroundColor Cyan
