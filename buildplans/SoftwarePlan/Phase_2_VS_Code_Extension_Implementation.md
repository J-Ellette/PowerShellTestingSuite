...
This document outlines the implementation details for Phase 2 of the PowerShell Testing Suite.
...
## Original Code: ${violation.code}

## Fixed Code:`

            'CredentialExposure': `

## Fix credential exposure vulnerability
...
## Vulnerable Code: ${violation.code}
